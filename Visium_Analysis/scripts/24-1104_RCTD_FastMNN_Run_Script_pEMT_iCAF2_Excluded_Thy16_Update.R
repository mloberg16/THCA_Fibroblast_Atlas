...
### Script: 24-1104_RCTD_FastMNN_Run_Script_pEMT_iCAF2_Excluded_Thy16_Update.R
...
for(i in 1:length(readdirs)){
  # Create resultsdir
  resultsdir <- "outputs/Thy16_RCTD/24-1104_iCAF2_Excluded_V2/"
  ...
  saveRDS(Thy_RCTD_Obj, file = paste0( "~/24-1104_Thy16_FastMNN_RCTD_Obj_iCAF2_Excluded_V2.RDS")) # Saving to the "documents" folder of the lab PC to save space on OneDrive; will back up on s drive, SharePoint
  ...
  # Save Thy_Spatial_SO
  saveRDS(Thy_Spatial_SO, file = "Data_in_Use/Pre_Processed_with_RCTD_Annotations/24-1104_iCAF2_Excluded/Thy16_V2.RDS")
