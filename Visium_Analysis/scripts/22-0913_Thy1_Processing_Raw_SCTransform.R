...
# Load in Thy1 data
data_dir <- 'Data_in_Use/2021_JHU_Data/Thy1' # Set directory to load from
...
# Save raw Thy1 as an RDS
saveRDS(Thy1, "Data_in_Use/2021_JHU_Data/Thy1_Processed/22-0913_Thy1_Raw_PreProcessed.rds")
...
Thy1 <- SCTransform(Thy1, assay = "Spatial", return.only.var.genes = FALSE, verbose = FALSE)

# Save SCTransformed Thy1 as an RDS
saveRDS(Thy1, "Data_in_Use/2021_JHU_Data/Thy1_Processed/22-0913_Thy1_SCTransformed_All_Genes.rds")
...
# Can use this SCTransformed assay to addmodule score (note for Andres 24-0126)
