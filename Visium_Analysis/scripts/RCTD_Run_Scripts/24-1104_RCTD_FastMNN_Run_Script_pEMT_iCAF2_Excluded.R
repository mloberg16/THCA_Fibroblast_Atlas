...
pt.size.factor <- list(3, 3, 3, 3, 1.6, 1.7, 1.7, 1.7, 1.7, 1.6, 
                       1.6, 1.6, 1.6, 1.6, 1.6, 1.6, 1.6, 1.6, 1.9, 1.6)
...
for(i in 1:length(readdirs)){
  ...
  saveRDS(Thy_RCTD_Obj, file = paste0( "~/24-1104_Thy", i, "_FastMNN_RCTD_Obj_iCAF2_Excluded.RDS")) # Saving to the "documents" folder of the lab PC to save space on OneDrive; will back up on s drive, SharePoint
  ...
  # Save Thy_Spatial_SO
  saveRDS(Thy_Spatial_SO, file = paste0("Data_in_Use/Pre_Processed_with_RCTD_Annotations/24-1104_iCAF2_Excluded/Thy", i, ".RDS"))
