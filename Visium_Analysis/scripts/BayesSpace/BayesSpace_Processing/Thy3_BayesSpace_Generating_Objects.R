...
### Date: 23-0113
### Script: Thy3_BayesSpace_Generating_Objects.R
### Source Script Name: 23-0113_Thy3_BayesSpace_Generating_Object.R

# Today I will generate SCE + Clustering for Thy3
...
# Load Thy3 as a single cell experiment
sce <- readVisium(Dir)
...
Thy3_Clustering <- clusterPlot(sce)
ggsave("outputs/Thy3_BayesSpace/23-0113_Thy3_BayesSpace_Clustering/23-0113_Thy3_BayesSpace_Clustering.png",
       Thy3_Clustering,
...
Thy3_Enhanced_Clustering <- clusterPlot(sce.enhanced)
ggsave("outputs/Thy3_BayesSpace/23-0113_Thy3_BayesSpace_Clustering/23-0113_Thy3_BayesSpace_EnhancedClustering.png",
       Thy3_Enhanced_Clustering,
       width = 4, height = 5, dpi = 600)
rm(Thy3_Enhanced_Clustering)

# Save sce and sce.enhanced as R objects to prevent need to rerun script
saveRDS(sce, "Data_in_Use/Processed_Outputs/Thy3_Processed/Thy3_BayesSpace.RDS")
saveRDS(sce.enhanced, "Data_in_Use/Processed_Outputs/Thy3_Processed/Thy3_BayesSpace_Enhanced.RDS"); beep()
