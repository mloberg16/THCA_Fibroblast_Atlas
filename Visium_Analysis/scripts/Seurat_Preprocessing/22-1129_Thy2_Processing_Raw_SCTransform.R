...
# Load in Thy2 data
data_dir <- 'Data_in_Use/2021_JHU_Data/Thy2' # Set directory to load from
...
plot1 <- VlnPlot(Thy2, features = "nCount_Spatial", raster = FALSE) + NoLegend()

# Visiualize spatial location of raw count data
plot2 <- SpatialFeaturePlot(Thy2, features = "nCount_Spatial") + theme(legend.position = "right")
...
ggsave("outputs/Thy2_QC/22-1129_Thy2_Processing_Raw_SCTransform/22-1129_Raw_Counts_Violin.png",
       plot1,
...
ggsave("outputs/Thy2_QC/22-1129_Thy2_Processing_Raw_SCTransform/22-1129_Raw_Counts_Spatial.png",
       plot2,
...
# Save raw Thy2 as an RDS
saveRDS(Thy2, "Data_in_Use/2021_JHU_Data/Thy2_Processed/22-1129_Thy2_Raw_PreProcessed.rds")
...
Thy2 <- SCTransform(Thy2, assay = "Spatial", return.only.var.genes = FALSE, verbose = FALSE)

# Save SCTransformed Thy2 as an RDS
saveRDS(Thy2, "Data_in_Use/2021_JHU_Data/Thy2_Processed/22-1129_Thy2_SCTransformed_All_Genes.rds")

# Cleaning up
rm(Thy2)

# I will start subsequent analysis by loading the SCTransformed/processed version of Thy2
