...
# Date: July 5, 2023
# Script: 23-0705_GSM5814579_PTC_05_RAW_SO.R

# Goals:
# Read in and create a Seurat object out of PTC_05
...
PTC_05_Counts <- read.table(gzfile("data_in_use/Lu_etal_2023_ATC_scRNA/GSE193581_RAW/GSM5814579_PTC05_UMI.txt.gz"))
...
SO <- CreateSeuratObject(counts = PTC_05_Counts, project = "Lu et al. 2023", orig.ident = "PTC_05", min.cells = 3, min.features = 200)
...
ggsave("outputs/Lu_etal_2023_Analysis_Outputs/Individual_Sample_Analysis_Outputs/GSM5814579_PTC05/PTC05_QC_VLN.png",
       QC_Plots,
...
Annotation <- Annotation %>% subset(sample.ID == "PTC05") # Not sure why there is a T in the annotation file
SO$External_Cell_Type <- Annotation$celltype

# Save the raw Seurat Object
saveRDS(SO, file = "data_in_use/Lu_etal_2023_ATC_scRNA/RAW_SOs/GSM5814579_PTC05.RDS")
