...
# Date: July 5, 2023
# Script: 23-0705_GSM5814588_ATC_13_RAW_SO.R

# Goals:
# Read in and create a seurat object out of ATC_13
...
ATC_13_Counts <- read.table(gzfile("data_in_use/Lu_etal_2023_ATC_scRNA/GSE193581_RAW/GSM5814588_ATC13_UMI.txt.gz"))
...
SO <- CreateSeuratObject(counts = ATC_13_Counts, project = "Lu et al. 2023", orig.ident = "ATC_13", min.cells = 3, min.features = 200)
...
ggsave("outputs/Lu_etal_2023_Analysis_Outputs/Individual_Sample_Analysis_Outputs/GSM5814588_ATC13/ATC13_QC_VLN.png",
       QC_Plots,
...
Annotation <- Annotation %>% subset(sample.ID == "ATC13")
SO$External_Cell_Type <- Annotation$celltype

# Save the raw Seurat Object
saveRDS(SO, file = "data_in_use/Lu_etal_2023_ATC_scRNA/RAW_SOs/GSM5814588_ATC13.RDS")
