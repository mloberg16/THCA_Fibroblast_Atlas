...
# Date: July 5, 2023
# Script: 23-0705_GSM5814586_ATC_11_RAW_SO.R

# Goals:
# Read in and create a seurat object out of ATC_11
...
ATC_11_Counts <- read.table(gzfile("data_in_use/Lu_etal_2023_ATC_scRNA/GSE193581_RAW/GSM5814586_ATC11_UMI.txt.gz"))
...
SO <- CreateSeuratObject(counts = ATC_11_Counts, project = "Lu et al. 2023", orig.ident = "ATC_11", min.cells = 3, min.features = 200)

# Print out SO features
SO
# An object of class Seurat
# 17,858 features across 3,226 samples within 1 assay
# Active assay: RNA (17,858 features, 0 variable features)
# This indicates that all 3,226 cells had at least 200 features but only 17,858 features were present in at least 3 cells
...
ggsave("outputs/Lu_etal_2023_Analysis_Outputs/Individual_Sample_Analysis_Outputs/GSM5814586_ATC11/ATC11_QC_VLN.png",
       QC_Plots,
...
Annotation <- Annotation %>% subset(sample.ID == "ATC11")
SO$External_Cell_Type <- Annotation$celltype

# Save the raw Seurat Object
saveRDS(SO, file = "data_in_use/Lu_etal_2023_ATC_scRNA/RAW_SOs/GSM5814586_ATC11.RDS")
