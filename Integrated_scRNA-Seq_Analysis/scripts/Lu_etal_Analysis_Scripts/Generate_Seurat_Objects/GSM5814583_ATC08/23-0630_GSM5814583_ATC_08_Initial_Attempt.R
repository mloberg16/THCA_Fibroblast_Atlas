...
# Date: June 30, 2023
# Script: 23-0630_GSM5814583_ATC_08_Initial_Attempt.R

# Goals:
# Read in and create a seurat object out of ATC_08
...
ATC_08_Counts <- read.table(gzfile("data_in_use/Lu_etal_2023_ATC_scRNA/GSE193581_RAW/GSM5814583_ATC08_UMI.txt.gz"))
# Notes on the data: there are 38,224 rows (genes) and 8,994 columns (cells)
# See that here:
nrow(ATC_08_Counts)
ncol(ATC_08_Counts)

# Turn the raw count data into a Seurat object
SO <- CreateSeuratObject(counts = ATC_08_Counts, project = "Lu et al. 2023", orig.ident = "ATC_08", min.cells = 3, min.features = 200)

# Print out SO features
SO
# An object of class Seurat
# 18,514 features across 8,994 samples within 1 assay
# Active assay: RNA (18,514 features, 0 variable features)
# This indicates that all 8,994 cells had at least 200 features but only 18,514 features were present in at least 3 cells
...
# 0% = 0.02%, 25% = 4.61%, 50% = 7.08%, 75% = 13.09%, 100% = 29.98%
...
ggsave("outputs/Lu_etal_2023_Analysis_Outputs/Individual_Sample_Analysis_Outputs/GSM5814583_ATC08/ATC08_QC_VLN.png",
       QC_Plots,
...
saveRDS(SO, file = "data_in_use/Lu_etal_2023_ATC_scRNA/RAW_SOs/GSM5814583_ATC08.RDS")
