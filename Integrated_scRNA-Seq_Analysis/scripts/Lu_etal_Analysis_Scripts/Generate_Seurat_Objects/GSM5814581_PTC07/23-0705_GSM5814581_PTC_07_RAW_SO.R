...
# Date: July 5, 2023
# Script: 23-0705_GSM5814581_PTC_07_RAW_SO.R

# Goals:
# Read in and create a Seurat object out of PTC_07
...
PTC_07_Counts <- read.table(gzfile("data_in_use/Lu_etal_2023_ATC_scRNA/GSE193581_RAW/GSM5814581_PTC07_UMI.txt.gz"))
...
SO <- CreateSeuratObject(counts = PTC_07_Counts, project = "Lu et al. 2023", orig.ident = "PTC_07", min.cells = 3, min.features = 200)
...
ggsave("outputs/Lu_etal_2023_Analysis_Outputs/Individual_Sample_Analysis_Outputs/GSM5814581_PTC07/PTC07_QC_VLN.png",
       QC_Plots,
...
Annotation <- Annotation %>% subset(sample.ID == "PTC07") # Not sure why there is a T in the annotation file
SO$External_Cell_Type <- Annotation$celltype

# Save the raw Seurat Object
saveRDS(SO, file = "data_in_use/Lu_etal_2023_ATC_scRNA/RAW_SOs/GSM5814581_PTC07.RDS")
