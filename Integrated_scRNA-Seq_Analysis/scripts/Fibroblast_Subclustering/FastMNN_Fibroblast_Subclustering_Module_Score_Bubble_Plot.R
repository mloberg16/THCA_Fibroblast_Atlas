...
### Script: FastMNN_Fibroblast_Subclustering_3000_Module_Score_Bubble_Plot.R
### Source Script Name: "24-1126_FastMNN_Fibroblast_Subclustering_3000_Module_Score_bubble_plot.R"

# Goal: Make a bubble plot of fibroblast module scores that have been added to the subclustered stromal cells

# 24-1126 Update:
# This is updated from 24-1125_FastMNN_Fibroblast_Subclustering_3000_Module_Score_bubble_plot.R
# I've added additional module scores from Belle, Dinh, and Ma
...
##### Feature Dot Plot #####
# Choose stromal scores (from published papers) to plot in the desired order to plot them
Bubble_Plot_Stromal_Scores <- c(
                               "Hornburg_IL1_CAF_Mod_Score1",
                               "IL_iCAF_Mod_Score1",
                               "Detox_iCAF_Mod_Score1",
                               "Ma_iCAF_Mod_Score1",
                               "Wu_TN_iCAF_Mod_Score1",
                               "Belle_iCAF_Mod_Score1",
                               "Elyada_iCAF_Mod_Score1",
                               "Cords_iCAF_Mod_Score1",
                               "IFNg_iCAF_Mod_Score1",
                               "Iesato_Fibroblast_Mod_Score1",
                               "CAFS1_Mod_Score1", 
                               "Wound_myCAF_Mod_Score1",
                               "Belle_myCAF1_Mod_Score1",
                               "Belle_myCAF2_Mod_Score1",
                               "Belle_myCAF3_Mod_Score1",
                               "Cords_ifnCAF_Mod_Score1",
                               "Cords_mCAF_Mod_Score1",
                               "Ma_mCAF_Mod_Score1",
                               "Ma_meCAF_Mod_Score1",
                               "Cords_tCAF_Mod_Score1",
                               "Cords_dCAF_Mod_Score1",
                               "Ma_pCAF_Mod_Score1",
                               "ecm_myCAF_Mod_Score1",
                               "TGFB_myCAF_Mod_Score1",
                               "Hornburg_TGFB_CAF_Mod_Score1",
                               "Wu_TN_myCAF_Mod_Score1",
                               "Dinh_Activated_Myofibroblast_Mod_Score1",
                               "Elyada_myCAF_Mod_Score1",
                               "Cords_hsp_tCAF_Mod_Score1",
                               "Wu_TN_imPVL_Mod_Score1",
                               "Iesato_Pericyte_Mod_Score1",
                               "Ma_Pericyte_Mod_Score1",
                               "Cords_Pericyte_Mod_Score1",
                               "Cords_rCAF_Mod_Score1",
                               "CAFS4_Mod_Score1",
                               "Wu_TN_dPVL_Mod_Score1",
                               "Cords_vCAF_Mod_Score1",
                               "Ma_SMC_Mod_Score1")

# Make a feature dotplot for the above stromal scores
# Need to reorder factor levels for Idents for this to plot in the order that I want it to 
...
Merged_SO_FastMNN@active.ident <- factor(Merged_SO_FastMNN@active.ident,
                                         levels = c("5", # iCAF2 -> almost entirely from 1 Pu et al. sample -> ultimately exclude from plot
                                                    "1", # iCAF
                                                    "2", # myCAF
                                                    "4", # APOE+ PVL
                                                    "0", # Pericyte
...
# Make plot
Feature_DotPlot <- DotPlot(Merged_SO_FastMNN %>% subset(CAF_Labels != "iCAF2"),  # Excluded iCAF2 (largely from one sample from Pu et al.)
                           features = Bubble_Plot_Broad_Markers, 
                           assay = "RNA", 
                           dot.scale = 7.3) +
# scale_color_viridis_c(option = "plasma") +  # Alternate color scheme
  scale_colour_distiller(palette = "RdYlBu") + # Chosen color scheme
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

# Save plot
ggsave(file = "outputs/Fibroblast_Subclustering/24-0821_Fibroblast_Subclustering/FastMNN_3000/DotPlots/24-1127_CAF_Module_Score_DotPlot_Height_Change.png",
       Feature_DotPlot, width = 13, height = 5, dpi = 600, create.dir = TRUE)
