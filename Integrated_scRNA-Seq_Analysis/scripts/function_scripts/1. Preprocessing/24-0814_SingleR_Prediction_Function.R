...
### Date: August 14, 2024
### Script: 24-0814_SingleR_Prediction_Function.R

### Goal:
# Run SingleR Prediction for human primary cell atlas (HPCA), Myeloid reference, CD4 reference, and CD8 reference

# 24-0814 Update
# Only new change here is the addition of create.dir = TRUE on the first plot to make sure that there are no outputdir problems
