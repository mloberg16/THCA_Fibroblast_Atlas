...
### Script: "FastMNN_3000_bubble_plot.R"
### Source Script Name: 24-1111_FastMNN_3000_bubble_plot.R

# This is adapted from 24-0819_FastMNN_3000.R (GitHub script FastMNN_3000_Cleaned.R)

# Goal: make a bubble plot (Seurat DotPlot) of marker genes of broad populations for the overall thyroid cancer atlas
...
# Make a feature dotplot for broad population markers
# Need to reorder factor levels for Idents for this to work in the desired order for the plot
# Kind of backwards but put the ones I want to see at the top of the plot (top row) at the bottom of the idents ordering
...
ggsave(file = "outputs/24-0819_Atlas_Integration/FastMNN_3000/DotPlots/24-1111_Broad_Cell_Type_Markers.png",
